...
public class DevSaudavel {
	...
	public static void main(String[] args) {
		...
		if (opcao == 1) {
			...
			System.out.print("\n\nDinheiro à vista");
			System.out.println("9% de ICMS : R$ "+((total * 0.09),2));
			System.out.println("10% de desconto : R$ "+((total * 0.1),2));
			System.out.println("\nTOTAL DA COMPRA R$ "+((total * 0.9),2),"\n");
			// data/hora atual
		...
		if (opcao == 2) {
			...
			System.out.print("\n\nCartão à vista");
			System.out.println("9% de ICMS : R$ "+((total * 0.09),2));
			System.out.println("10% de acréscimo : R$ "+((total * 0.1),2));
			System.out.println("\nTOTAL DA COMPRA R$ "+((total * 1.1),2),"\n");
			// data/hora atual
			LocalDateTime agora = LocalDateTime.now();
			// formatar a data
			DateTimeFormatter formatterData = DateTimeFormatter.ofPattern("dd/MM/uuuu");
		...
		//Opção de pagamento 3 - em 2X no cartão.
			...
			System.out.print("\n\n2X no Cartão");
			System.out.println("9% de ICMS : R$ "+((total * 0.09),2));
			System.out.println("15% de acréscimo : R$ "+((total * 0.1),2));
			System.out.println("\nValor da parcela : R$ "+((total * 1.15),2)/2,"\n");
			System.out.println("\nTOTAL DA COMPRA R$ " + ((total * 1.1),2),"\n");
			// data/hora atual
			LocalDateTime agora = LocalDateTime.now();
			// formatar a data
